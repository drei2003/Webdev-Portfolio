...
<html data-bs-theme="light" lang="en">
    ...
    <body>
        ...
        <!-- End: Footer Multi Column --><!-- Start: UploadBookModal -->
            ...
            >
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Upload A Book</h4>
                        <button
                            class="btn-close"
                            type="button"
                            aria-label="Close"
                                ...
                                <form class="px-4 py-4">
                                    ...
                                    ><textarea
                                        ...
                                        style="
                                            ...
                                            background: #f5f6fa;
                                        "
                                        name="aboutAuthor/writer"
                                    ></textarea
                                    ><label
                                        class="form-label"
                                        style="font-size: 20px"
                                        >Books Description&nbsp;</label
                                    ><textarea
                                        class="form-control"
                                        style="
                                            border-radius: 8px;
